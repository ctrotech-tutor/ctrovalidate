...
description: >-
  A high-performance, modular JavaScript validation suite. HTML-first declarative logic with universal core execution
  and framework-native headless adapters.
---
