...
breadcrumb:
  ...
  - name: Guide
    url: https://ctrovalidate.vercel.app/guide/dynamic-fields
  - name: Dynamic Fields
    url: https://ctrovalidate.vercel.app/guide/dynamic-fields
---
...
- Clears all tracked fields and re-discovers from scratch.
- Scans for `data-ctrovalidate-rules` attributes and schema-based fields.
- Attaches listeners to all discovered fields.
- Call after dynamically adding or removing fields in bulk.
...
- [**API Reference**](/api/browser) — Full documentation of all 9 controller methods.
