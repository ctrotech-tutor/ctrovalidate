...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'v2.0.0 (Latest)', items: [
          { text: 'Changelog', link: 'https://github.com/ctrotech-tutor/ctrovalidate/blob/main/CHANGELOG.md' },
          { text: 'Releases', link: 'https://github.com/ctrotech-tutor/ctrovalidate/releases' },
        ]
      }
    ],
      ...
      '/2.0/guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Conditional Validation', link: '/2.0/guide/conditional-validation' },
            { text: 'Working with SPAs', link: '/2.0/guide/spa-dynamic-fields' },
          ]
        },
        {
          text: 'Advanced',
      ...
      '/2.0/project/': [
        {
          text: 'Project Info',
          items: [
            { text: 'Release Policy', link: '/2.0/project/releases' },
          ]
        }
      ]
    },
