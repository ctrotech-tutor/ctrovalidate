...
const re = {},
  ...
  zr = (e) => (ee(e) || G(e)) && G(e.then) && G(e.catch),
  ...
  No = /-\w/g,
  Le = Fn((e) => e.replace(No, (t) => t.slice(1).toUpperCase())),
  Fo = /\B([A-Z])/g,
  at = Fn((e) => e.replace(Fo, '-$1').toLowerCase()),
...
const ni = (e) => !!(e && e.__v_isRef === !0),
  Bo = (e) =>
    le(e)
      ...
      : e == null
        ? ''
        : B(e) || (ee(e) && (e.toString === Qr || !G(e.toString)))
          ? ni(e)
            ? Bo(e.value)
...
function ai(e) {
  ...
  for (; s; ) {
    const r = s.prevDep;
    (s.version === -1 ? (s === n && (n = r), ks(s), Go(s)) : (t = s),
...
function fi(e) {
  if (
    ...
    ((e.globalVersion = Gt),
    !e.isSSR && e.flags & 128 && ((!e.deps && !e._dirty) || !Ss(e)))
  )
    return;
  e.flags |= 2;
  const t = e.dep,
...
class $n {
  ...
  track(t) {
    ...
    if (n === void 0 || n.sub !== se)
      ((n = this.activeLink = new Xo(se, this)),
        se.deps
...
function Ge(e, t, n, s, r, i) {
  ...
  if ((Vs(), t === 'clear')) l.forEach(o);
    ...
    if (c && n === 'length') {
      ...
      switch (
        ((n !== void 0 || l.has(void 0)) && o(l.get(n)), u && o(l.get(Xt)), t)
      ) {
        case 'add':
          c ? u && o(l.get('length')) : (o(l.get(mt)), Ot(e) && o(l.get(xs)));
          break;
        case 'delete':
          c || (o(l.get(mt)), Ot(e) && o(l.get(xs)));
          break;
        case 'set':
          Ot(e) && o(l.get(mt));
          break;
...
function nt(e, t) {
  return Je(e) ? (lt(e) ? Ft(He(t)) : Ft(t)) : He(t);
}
const Jo = {
  __proto__: null,
  [Symbol.iterator]() {
  ...
  concat(...e) {
    return Ct(this).concat(...e.map((t) => (B(t) ? Ct(t) : t)));
  },
  entries() {
...
const Qo = Fs('__proto__,__v_isRef,__isVue'),
  hi = new Set(
...
class pi {
  ...
  get(t, n, s) {
    ...
    if (n === '__v_raw')
      return s === (r ? (i ? al : yi) : i ? vi : mi).get(t) ||
    ...
    if (!r) {
      let c;
      if (l && (c = Jo[n])) return c;
      if (n === 'hasOwnProperty') return Zo;
    }
    const o = Reflect.get(t, n, ae(t) ? t : s);
    if ((Ze(n) ? hi.has(n) : Qo(n)) || (r || me(t, 'get', n), i)) return o;
    if (ae(o)) {
      const c = l && Nn(n) ? o : o.value;
      return r && ee(c) ? Yt(c) : c;
    }
    return ee(o) ? (r ? Yt(o) : Nt(o)) : o;
  }
}
class gi extends pi {
  constructor(t = !1) {
  ...
  set(t, n, s, r) {
    ...
    return (
      t === z(r) && (o ? ot(s, i) && Ge(t, 'set', n, s) : Ge(t, 'add', n, s)),
      c
    );
  }
  deleteProperty(t, n) {
  ...
  ownKeys(t) {
    return (me(t, 'iterate', B(t) ? 'length' : mt), Reflect.ownKeys(t));
  }
}
class el extends pi {
  constructor(t = !1) {
...
function il(e, t) {
  const n = {
    ...
    get size() {
      const r = this.__v_raw;
      return (!e && me(z(r), 'iterate', mt), r.size);
    },
    has(r) {
      const i = this.__v_raw,
        l = z(i),
    ...
    forEach(r, i) {
      ...
      return (
        !e && me(c, 'iterate', mt),
        o.forEach((a, h) => r.call(i, u(a), u(h), l))
      );
    },
  };
  return (
      ...
      e
        ...
        : {
            add(r) {
              ...
              const i = z(this);
              return (
                cn(i).has.call(i, r) || (i.add(r), Ge(i, 'add', r, r)),
                this
              );
            },
            set(r, i) {
              ...
              return (
                l.set(r, i),
                u ? ot(i, a) && Ge(l, 'set', r, i) : Ge(l, 'add', r, i),
                this
              );
            },
            delete(r) {
...
function ul(e) {
  return e.__v_skip || !Object.isExtensible(e) ? 0 : fl(Lo(e));
}
function Nt(e) {
  return Je(e) ? e : Bs(e, !1, tl, ol, mi);
}
function dl(e) {
  return Bs(e, !1, sl, ll, vi);
}
function Yt(e) {
  return Bs(e, !0, nl, cl, yi);
}
...
function bn(e) {
  return (
    !Q(e, '__v_skip') && Object.isExtensible(e) && ei(e, '__v_skip', !0),
    e
  );
}
const He = (e) => (ee(e) ? Nt(e) : e),
  Ft = (e) => (ee(e) ? Yt(e) : e);
function ae(e) {
...
const fn = {},
  En = new WeakMap();
let pt;
function xl(e, t = !1, n = pt) {
  if (n) {
    let s = En.get(n);
    (s || En.set(n, (s = [])), s.push(e));
  }
}
function Tl(e, t, n = re) {
  const {
      immediate: s,
      deep: r,
      once: i,
...
function Ks(e) {
  if (!(e.flags & 1)) {
    const t = Jt(e),
      n = _e[_e.length - 1];
    (!n || (!(e.flags & 2) && t >= Jt(n)) ? _e.push(e) : _e.splice(Cl(t), 0, e),
      (e.flags |= 1),
      Si());
  }
}
  ...
  Il = {
    ...
    setup(e, { slots: t }) {
      ...
      return () => {
        ...
        if (a && a.type !== ue && !gt(a, c) && Ai(n).type !== ue) {
          let h = Es(a, l, s, n);
...
function Es(e, t, n, s, r) {
  const {
    ...
    R = (T, I) => {
      const E = I[1];
      (W(T, I),
        B(T) ? T.every((y) => y.length <= 1) && E() : T.length <= 1 && E());
    },
    U = {
      mode: l,
      persisted: o,
...
function rs(e) {
  if (Bn(e)) return ((e = ct(e)), (e.children = null), e);
}
function cr(e) {
  if (!Bn(e)) return Ei(e.type) && e.children ? Ri(e.children) : e;
...
function Oi(e, t = !1, n) {
  ...
  for (let i = 0; i < e.length; i++) {
    ...
    l.type === be
      ? (l.patchFlag & 128 && r++, (s = s.concat(Oi(l.children, t, o))))
  ...
  const {
    ...
    h = (p, g, O, W, R, U = !1) => {
      ...
      switch (E) {
        ...
        case ue:
          V(p)
            ? (($ = i(p)), H((g.el = p.content.firstChild), p, O))
            : ie !== 8 || T
              ? ($ = I())
              : ($ = i(p));
          break;
        ...
        default:
          if (N & 1)
            ...
            N & 64
              ? ie !== 8
                ? ($ = I())
                : ($ = g.type.hydrate(p, g, O, W, R, U, e, _))
              : N & 128 &&
                ($ = g.type.hydrate(p, g, O, W, dn(l(p)), R, U, e, h));
      }
      return (y != null && Lt(y, null, W, g), $);
    },
    v = (p, g, O, W, R, U) => {
      U = U || !!g.dynamicChildren;
      const {
      ...
      if (ie || E !== -1) {
        ...
        let $ = !1;
        if (V(p)) {
          $ = to(null, Y) && O && O.vnode.props && O.vnode.props.appear;
          const D = p.content.firstChild;
          if ($) {
            const te = D.getAttribute('class');
            (te && (D.$cls = te), Y.beforeEnter(D));
          }
          (H(D, p, O), (g.el = p = D));
        }
...
`
            ...
            (pn(p, 0) || At(), (p.textContent = g.children));
        }
        if (I) {
          if (ie || !U || E & 48) {
            const D = p.tagName.includes('-');
            for (const te in I)
              ((ie && (te.endsWith('value') || te === 'indeterminate')) ||
                (nn(te) && !It(te)) ||
                te[0] === '.' ||
                D) &&
                s(p, te, null, I[te], void 0, O);
      ...
      for (let y = 0; y < E; y++) {
        ...
        p
          ? (Y &&
              ...
              y + 1 < E &&
              Oe(I[y + 1]).type === wt &&
              (c(r(p.data.slice(N.children.length)), O, i(p)),
              (p.data = N.children)),
            (p = h(p, N, W, R, U, T)))
          : Y && !N.children
            ? c((N.el = r('')), O)
            : (pn(O, 1) || At(), n(null, N, O, null, W, R, dn(O), U));
      }
      return p;
    },
    C = (p, g, O, W, R, U) => {
      ...
      return E && hn(E) && E.data === ']'
        ? i((g.anchor = E))
        : (At(), c((g.anchor = u(']')), I, E), E);
    },
    P = (p, g, O, W, R, U) => {
      if ((pn(p.parentElement, 1) || At(), (g.el = null), U)) {
        const E = K(p);
        for (;;) {
          const y = i(p);
          if (y && y !== E) o(y);
      ...
      return (
        o(p),
        n(null, g, I, T, O, W, dn(I), R),
        O && ((O.vnode.el = g.el), qi(O, g.el)),
        T
      );
    },
    K = (p, g = '[', O = ']') => {
...
function pn(e, t) {
  ...
  {
    const s = n.split(',');
    return t === 0 && s.includes('children') ? !0 : s.includes(Hl[t]);
  }
}
...
function Li(e, t, n = ve) {
  ...
  if ((Kn(t, s, n), n)) {
    let r = n.parent;
    for (; r && r.parent; )
      (Bn(r.parent.vnode) && jl(s, t, n, r), (r = r.parent));
  }
}
function jl(e, t, n, s) {
  const r = Kn(t, e, s, !0);
...
const Fi = 'components';
function gf(e, t) {
  return Di(Fi, e, !0, t) || e;
}
const Hi = Symbol.for('v-ndc');
function mf(e) {
  return le(e) ? Di(Fi, e, !1) || e : e || Hi;
}
...
function yf(e, t, n = {}, s, r) {
  if (we.ce || (we.parent && yt(we.parent) && we.parent.ce)) {
    ...
    return (
      t !== 'default' && (n.name = t),
      Os(),
      Is(be, null, [de('slot', n, s && s())], u ? -2 : 64)
    );
  }
  let i = e[t];
  (i && i._c && (i._d = !1), Os());
...
function $i(e) {
  return e.some((t) =>
    Zt(t) ? !(t.type === ue || (t.type === be && !$i(t.children))) : !0
  )
    ? e
    : null;
}
...
const Cs = (e) => (e ? (fo(e) ? Ys(e) : Cs(e.parent)) : null),
...
function Xl(e) {
  const t = Tt();
  return t.setupContext || (t.setupContext = ho(t));
}
function hr(e) {
...
function Yl(e) {
  ...
  if (((As = !0), i))
    for (const X in i) {
      const D = i[X],
        te = G(D) ? D.bind(n, n) : G(D.get) ? D.get.bind(n, n) : ke,
  ...
  if (o) for (const X in o) ji(o[X], s, n, X);
  if (c) {
  ...
  a && pr(a, e, 'c');
  function $(X, D) {
    B(D) ? D.forEach((te) => X(te.bind(n))) : D && X(D.bind(n));
  }
  if (
    ($(Vl, h),
    $(Ht, v),
  ...
  return (
    o
      ...
      : !r.length && !n && !s
        ? (c = t)
        : ((c = {}),
          r.length && r.forEach((u) => On(c, u, l, !0)),
          On(c, t, l)),
    ee(t) && i.set(t, c),
    c
  );
...
function Gn(e, t, n = re) {
  ...
  (i === 'post'
    ...
    (o.augmentJob = (_) => {
      (t && (_.flags |= 4),
        h && ((_.flags |= 2), a && ((_.id = a.uid), (_.i = a))));
    }));
  const v = Tl(e, t, o);
...
function ic(e, t, n) {
  const s = this.proxy,
    r = le(e) ? (e.includes('.') ? Bi(s, e) : () => s[e]) : e.bind(s, s);
  let i;
...
function lc(e, t, ...n) {
  ...
  const i = t.startsWith('update:'),
    l = i && oc(s, t.slice(7));
  l &&
    (l.trim && (r = n.map((a) => (le(a) ? a.trim() : a))),
    l.number && (r = n.map(Ho)));
  let o,
...
function Ki(e, t, n = !1) {
  ...
  return !i && !o
    ...
    : (B(i) ? i.forEach((c) => (l[c] = null)) : fe(l, i),
      ee(e) && s.set(e, l),
      l);
}
function Xn(e, t) {
...
function os(e) {
  ...
  try {
    if (n.shapeFlag & 4) {
      ...
      const g = t;
      ((H = Oe(
        g.length > 1 ? g(h, { attrs: o, slots: l, emit: c }) : g(h, null)
      )),
        (V = t.props ? o : ac(o)));
    }
  } catch (g) {
  ...
  if (V && P !== !1) {
    ...
    g.length &&
      O & 7 &&
      (i && g.some(Hs) && (V = fc(V, i)), (p = ct(p, V, !1, !0)));
  }
  return (
    n.dirs &&
      ((p = ct(p, null, !1, !0)),
...
function dc(e, t, n, s = !1) {
  ...
  (n ? (e.props = s ? r : dl(r)) : e.type.props ? (e.props = r) : (e.props = i),
    (e.attrs = i));
}
function hc(e, t, n, s) {
  const {
...
function Ms(e, t, n, s, r, i) {
  ...
  if (l != null) {
    ...
    l[0] &&
      (i && !o ? (s = !1) : l[1] && (s === '' || s === at(n)) && (s = !0));
  }
  return s;
}
const pc = new WeakMap();
function zi(e, t, n = !1) {
  const s = n ? pc : t.propsCache,
    r = s.get(e);
  if (r) return r;
  const i = e.props,
    l = {},
  ...
  if (!i && !c) return (ee(e) && s.set(e, Mt), Mt);
  if (B(i))
    for (let a = 0; a < i.length; a++) {
      const h = Le(i[a]);
      yr(h) && (l[h] = re);
...
function _c(e, t) {
  ...
  const {
      ...
      switch (S) {
        ...
        default:
          F & 1
            ...
            : F & 6
              ? N(f, d, m, x, b, w, L, M, A)
              : (F & 64 || F & 128) && S.process(f, d, m, x, b, w, L, M, A, Et);
      }
      k != null && b
    ...
    W = (f, d, m, x, b, w, L, M) => {
      let A, S;
      const { props: k, shapeFlag: F, transition: j, dirs: q } = f;
      if (
        ((A = f.el = l(f.type, w, k && k.is, k)),
        F & 8
          ? a(A, f.children)
          : F & 16 && U(f.children, A, null, x, b, ls(f, w), L, M),
        q && We(f, null, x, 'created'),
        R(A, f, f.scopeId, L, x),
        k)
      ) {
        for (const ne in k)
          ne !== 'value' && !It(ne) && i(A, ne, null, k[ne], w, x);
        ('value' in k && i(A, 'value', null, k.value, w),
          (S = k.onVnodeBeforeMount) && Me(S, x, f));
      }
      ...
      (J && j.beforeEnter(A),
        ...
        ((S = k && k.onVnodeMounted) || J || q) &&
          Ee(() => {
            (S && Me(S, x, f), J && j.enter(A), q && We(f, null, x, 'mounted'));
          }, b));
    },
    R = (f, d, m, x, b) => {
      ...
      if (b) {
        ...
        if (
          d === w ||
          (ro(w.type) && (w.ssContent === d || w.ssFallback === d))
        ) {
          const L = b.vnode;
    ...
    T = (f, d, m, x, b, w, L) => {
      ...
      if (
        (m && ut(m, !1),
        (q = j.onVnodeBeforeUpdate) && Me(q, m, d, f),
        ...
        if (A & 16) E(M, F, j, m, b);
          ...
          (A & 2 && F.class !== j.class && i(M, 'class', null, j.class, b),
          A & 4 && i(M, 'style', F.style, j.style, b),
          A & 8)
        ) {
      ...
      } else !L && S == null && E(M, F, j, m, b);
      ((q = j.onVnodeUpdated) || k) &&
        Ee(() => {
    ...
    I = (f, d, m, x, b, w, L) => {
      for (let M = 0; M < d.length; M++) {
        const A = f[M],
          S = d[M],
          k =
            A.el && (A.type === be || !gt(A, S) || A.shapeFlag & 198)
              ? h(A.el)
              : m;
    ...
    E = (f, d, m, x, b) => {
      if (d !== m) {
        if (d !== re)
          for (const w in d) !It(w) && !(w in m) && i(f, w, d[w], null, b, x);
        for (const w in m) {
          if (It(w)) continue;
          const L = m[w],
            M = d[w];
      ...
      (q && (M = M ? M.concat(q) : q),
        f == null
          ...
          : F > 0 && F & 64 && j && f.dynamicChildren
            ? (I(f.dynamicChildren, j, m, b, w, L, M),
    ...
    Y = (f, d, m, x, b, w, L) => {
      const M = (f.component = Ac(f, x, b));
      if ((Bn(f) && (M.ctx.renderer = Et), Rc(M, !1, L), M.asyncDep)) {
        if ((b && b.registerDep(M, $, L), !f.el)) {
    ...
    $ = (f, d, m, x, b, w, L) => {
      const M = () => {
        if (f.isMounted) {
          let { next: F, bu: j, u: q, parent: J, vnode: ne } = f;
          {
            const xe = so(f);
            if (xe) {
          ...
          if (
            ...
            const xe = () => {
              ((f.subTree = os(f)), Qn(j, f.subTree, f, b, null));
            };
            Ne && he.__asyncHydrate ? he.__asyncHydrate(j, f, xe) : xe();
          } else {
            Se.ce &&
              Se.ce._def.shadowRoot !== !1 &&
              Se.ce._injectChildStyle(he);
    ...
    te = (f, d, m, x, b, w, L, M, A) => {
      ...
      let j;
      for (j = 0; j < F; j++) {
        const q = (d[j] = A ? rt(d[j]) : Oe(d[j]));
        P(f[j], q, m, null, b, w, L, M, A);
      }
      ...
      if (S > F) {
        if (S <= j) {
          const q = j + 1,
            J = q < k ? d[q].el : x;
          for (; S <= j; )
            (P(null, (d[S] = A ? rt(d[S]) : Oe(d[S])), m, J, b, w, L, M, A),
              S++);
        }
      } else if (S > j) for (; S <= F; ) ($e(f[S], b, w, !0), S++);
      else {
        const q = S,
          J = S,
          ne = new Map();
        ...
        for (Z = tr.length - 1, S = he - 1; S >= 0; S--) {
          const Te = J + S,
            je = d[Te],
            nr = d[Te + 1],
            sr = Te + 1 < k ? nr.el || nr.placeholder : x;
          $t[S] === 0
    ...
    ft = (f, d, m, x, b = null) => {
      ...
      if (x !== 2 && S & 1 && M)
        if (x === 0) (M.beforeEnter(w), s(w, d, m), Ee(() => M.enter(w), b));
          ...
          const { leave: F, delayLeave: j, afterLeave: q } = M,
            J = () => {
    ...
    $e = (f, d, m, x = !1, b = !1) => {
      ...
      const J = k & 1 && j,
        ne = !yt(f);
      let Z;
      if ((ne && (Z = L && L.onVnodeBeforeUnmount) && Me(Z, d, f), k & 6))
        Io(f.component, m, x);
      else {
        if (k & 128) {
        ...
        (J && We(f, null, d, 'beforeUnmount'),
          k & 64
            ? f.type.remove(f, d, m, Et, x)
            : S && !S.hasOnce && (w !== be || (F > 0 && F & 64))
              ? Dt(S, d, m, !1, !0)
              : ((w === be && F & 384) || (!b && k & 16)) && Dt(A, d, m),
          x && Zs(f));
      }
  ...
  return (
    t && ([zn, Qn] = t(Et)),
    { render: er, hydrate: zn, createApp: tc(er, zn) }
  );
}
    ...
    for (let i = 0; i < s.length; i++) {
      ...
      (o.shapeFlag & 1 &&
        ...
        ((o.patchFlag <= 0 || o.patchFlag === 32) &&
          ((o = r[i] = rt(r[i])), (o.el = l.el)),
        !n && o.patchFlag !== -2 && no(l, o)),
        o.type === wt && o.patchFlag !== -1 && (o.el = l.el),
...
function oo(e) {
  return (
    (e.dynamicChildren = Qt > 0 ? Ce || Mt : null),
    wc(),
    Qt > 0 && Ce && Ce.push(e),
    e
  );
...
function Sf(e, t, n, s, r, i) {
  return oo(co(e, t, n, s, r, i, !0));
}
function Is(e, t, n, s, r) {
  return oo(de(e, t, n, s, r, !0));
}
function Zt(e) {
...
function Sc(e, t = null, n = null, s = 0, r = null, i = !1) {
  ...
  if ((Pc(e) && (e = e.__vccOpts), t)) {
    ...
    (o && !le(o) && (t.class = js(o)),
      ee(c) && (Vn(c) && !B(c) && (c = fe({}, c)), (t.style = $s(c))));
  }
  const l = le(e) ? 1 : ro(e) ? 128 : Ei(e) ? 64 : ee(e) ? 4 : G(e) ? 2 : 0;
  return co(e, t, n, s, r, l, i, !0);
}
function xc(e) {
...
function Tc(...e) {
  ...
  for (let n = 0; n < e.length; n++) {
    ...
    for (const r in s)
      if (r === 'class')
        t.class !== s.class && (t.class = js([t.class, s.class]));
...
let Pn, Ps;
{
  ...
  ((Pn = t('__VUE_INSTANCE_SETTERS__', (n) => (ve = n))),
...
const po = Ns ? (e) => Ns.createHTML(e) : (e) => e,
  ...
  Dc = fe({}, Ci, go),
  $c = (e) => ((e.displayName = 'Transition'), (e.props = Dc), e),
  Ef = $c((e, { slots: t }) => Ls(Pl, jc(e), t)),
  dt = (e, t = []) => {
...
function jc(e) {
  const t = {};
  for (const y in e) y in go || (t[y] = e[y]);
  if (e.css === !1) return t;
  const {
      name: n = 'v',
      type: s,
    ...
    E = (y) => (N, Y) => {
      ...
      (dt(ie, [N, $]),
        Er(() => {
          (ht(N, y ? c : i), Be(N, y ? a : o), Tr(ie) || Cr(N, s, P, $));
        }));
    };
  return fe(t, {
    onBeforeEnter(y) {
...
function Cr(e, t, n, s) {
  ...
  const { type: l, timeout: o, propCount: c } = kc(e, t);
  if (!l) return s();
  const u = l + 'end';
  let a = 0;
  const h = () => {
...
function Gc(e, t, n) {
  ...
  if (n && !r) {
    ...
    if (t !== n) {
      const l = s[Kc];
      (l && (n += ';' + l), (s.cssText = n), (i = qc.test(n)));
    }
  } else t && e.removeAttribute('style');
  Or in e && ((e[Or] = i ? s.display : ''), e[Bc] && (s.display = 'none'));
}
...
function Sn(e, t, n) {
  if (B(n)) n.forEach((s) => Sn(e, t, s));
    ...
    const s = Xc(e, t);
    Ir.test(n)
      ? e.setProperty(at(s), n.replace(Ir, ''), 'important')
      : (e[s] = n);
  }
}
...
const Zc = Promise.resolve(),
  ea = () => fs || (Zc.then(() => (fs = 0)), (fs = Date.now()));
function ta(e, t) {
  const n = (s) => {
    if (!s._vts) s._vts = Date.now();
    else if (s._vts <= n.attached) return;
    De(na(s, n.value), t, 5, [s]);
  };
  ...
  Af = (e, t) => {
    ...
    return (
      ...
      (n[s] = (r) => {
        if (!('key' in r)) return;
        const i = at(r.key);
        if (t.some((l) => l === i || la[l] === i)) return e(r);
      })
    );
  },
  ca = fe({ patchProp: sa }, Hc);
let us,
  jr = !1;
function aa() {
  return ((us = jr ? us : yc(ca)), (jr = !0), us);
}
const Rf = (...e) => {
...
const da = window.__VP_SITE_DATA__;
function mo(e) {
  return ri() ? (qo(e), !0) : !1;
}
const ds = new WeakMap(),
  ha = (...e) => {
    var t;
    const n = e[0],
      s = (t = Tt()) == null ? void 0 : t.proxy;
    if (s == null && !ki())
      throw new Error('injectLocal must be called in setup');
    return s && ds.has(s) && n in ds.get(s) ? ds.get(s)[n] : bt(...e);
  },
  vo = typeof window < 'u' && typeof document < 'u';
typeof WorkerGlobalScope < 'u' && globalThis instanceof WorkerGlobalScope;
const pa = Object.prototype.toString,
  ga = (e) => pa.call(e) === '[object Object]',
  xt = () => {},
  Vr = ma();
function ma() {
  var e, t;
...
function _a(e = yo, t = {}) {
  ...
  return { isActive: Yt(s), pause: r, resume: i, eventFilter: l };
}
function Wr(e) {
...
function zs(...e) {
  ...
  const t = e[0];
  return typeof t == 'function' ? Yt(ml(() => ({ get: t, set: xt }))) : vt(t);
}
function wa(e, t = 200, n = {}) {
  return Js(va(t, n), e);
}
function Sa(e, t = 200, n = !1, s = !0, r = !1) {
  return Js(ya(t, n, s, r), e);
}
function xa(e, t, n = {}) {
...
function Qe(...e) {
  const t = [],
    ...
    s = (o, c, u, a) => (
      o.addEventListener(c, u, a),
      () => o.removeEventListener(c, u, a)
    ),
    r = oe(() => {
    ...
    i = Ea(
      ...
      ([o, c, u, a]) => {
        ...
        const h = ga(a) ? { ...a } : a;
        t.push(
          ...o.flatMap((v) => c.flatMap((_) => u.map((C) => s(v, _, C, h))))
        );
      },
      { flush: 'post' }
    ),
...
const Ma = Symbol('vueuse-ssr-width');
function Oa() {
  const e = ki() ? ha(Ma, null) : null;
  return typeof e == 'number' ? e : void 0;
}
function _o(e, t = {}) {
  const { window: n = ze, ssrWidth: s = Oa() } = t,
...
function wo(e) {
  return _o('(prefers-color-scheme: dark)', e);
}
function La(e) {
  return e == null
    ? 'any'
...
function Fa(e, t, n, s = {}) {
  ...
  const {
    ...
    P = (a ? Ie : vt)(typeof t == 'function' ? t() : t),
    K = oe(() => ce(e));
  if (!n)
    try {
      n = bo('getDefaultStorage', () => {
        var E;
  ...
  const H = ce(t),
    V = La(H),
    p = (r = s.serializer) != null ? r : Na[V],
    { pause: g, resume: O } = Ta(P, () => R(P.value), {
      flush: i,
      deep: l,
      eventFilter: v,
    });
...
function Da(e = {}) {
  const {
    ...
    C =
      ...
      (l == null
        ? zs(s)
        : Fa(l, s, i, { window: r, listenToStorageChanges: o })),
    P = oe(() => (C.value === 'auto' ? _.value : C.value)),
    K = bo('updateHTMLAttrs', (g, O, W) => {
      const R =
        typeof g == 'string'
          ? r == null
            ? void 0
      ...
      a &&
        ...
        E.appendChild(document.createTextNode(Ha)),
  ...
  const { valueDark: t = 'dark', valueLight: n = '' } = e,
    s = Da({
      ...
      onChanged: (l, o) => {
        var c;
        e.onChanged
          ? (c = e.onChanged) == null || c.call(e, l === 'dark', o, l)
          : o(l);
      },
...
function ja(e, t = {}) {
  ...
  function P(R, U) {
    ...
    const Y =
      ((y = N == null ? void 0 : N.document) == null
        ? void 0
        : y.documentElement) ||
      (N == null ? void 0 : N.documentElement) ||
      N;
    (_ != null && (h.value = Y.scrollLeft),
      C != null && (v.value = Y.scrollTop));
  }
  const K = Ie(!1),
    ...
    O = (R) => {
      ...
      const D = Math.abs(X) <= (l.top || 0),
        te =
          Math.abs(X) + T.clientHeight >= T.scrollHeight - (l.bottom || 0) - Ur;
...
function Pf(e = {}) {
  const {
    ...
    u = () => {
      if (t)
        if (l === 'outer')
          ((o.value = t.outerWidth), (c.value = t.outerHeight));
  ...
  if (
    ...
    t &&
      l === 'visual' &&
      t.visualViewport &&
      Qe(t.visualViewport, 'resize', u, a),
    r)
  ) {
    const h = _o('(orientation: portrait)');
    Pe(h, () => u());
  }
...
function Br(e) {
  return decodeURI(e).replace(Ua, '').replace(Ba, '$1');
}
function qa(e) {
  return xo.test(e);
}
...
function Xa(e, t) {
  ...
  return Object.assign({}, e, {
    ...
    titleTemplate:
      ((l = e.locales[n]) == null ? void 0 : l.titleTemplate) ??
      e.titleTemplate,
    description:
      ((o = e.locales[n]) == null ? void 0 : o.description) ?? e.description,
    head: Co(e.head, ((c = e.locales[n]) == null ? void 0 : c.head) ?? []),
    themeConfig: {
      ...e.themeConfig,
  ...
  if (ys.size === 0) {
    const n =
      (typeof process == 'object' &&
        (vs == null ? void 0 : vs.VITE_EXTRA_EXTENSIONS)) ||
...
const ef = Symbol(),
  St = Ie(da);
function Lf(e) {
  const t = oe(() => Xa(St.value, e.data.relativePath)),
...
function qr(e) {
  return xo.test(e) || !e.startsWith('/') ? e : nf(St.value.base, e);
}
function sf(e) {
...
const of = Symbol(),
  Ao = 'http://a.com',
  lf = () => ({ path: '/', component: null, data: To });
function Ff(e, t) {
  const n = Nt(lf()),
    s = { route: n, go: r };
  async function r(o = ge ? location.href : '/') {
    var c, u;
    ((o = _s(o)),
      (await ((c = s.onBeforeRouteChange) == null ? void 0 : c.call(s, o))) !==
        !1 &&
        (ge &&
          o !== _s(location.href) &&
  ...
  async function l(o, c = 0, u = !1) {
    var v, _;
    if (
      (await ((v = s.onBeforePageLoad) == null ? void 0 : v.call(s, o))) === !1
    )
      return;
    const a = new URL(o, Ao),
      h = (i = a.pathname);
    try {
      let C = await e(h);
        ...
        (await ((_ = s.onAfterPageLoad) == null ? void 0 : _.call(s, o)),
          ...
          ge &&
            Un(() => {
              ...
              if (
                (!St.value.cleanUrls && !H.endsWith('/') && (H += '.html'),
                H !== a.pathname &&
                  ((a.pathname = H),
                  (o = H + a.search + a.hash),
      ...
      if (
        ...
        try {
          const P = await fetch(St.value.base + 'hashmap.json');
          ...
          h === P.origin &&
            ...
            v === P.pathname && C === P.search
              ? (_ !== P.hash &&
                ...
                _
                  ? Xr(c, _, c.classList.contains('header-anchor'))
                  : window.scrollTo(0, 0))
              : r(a));
        },
        { capture: !0 }
...
function Xr(e, t, n = !1) {
  ...
  if (s) {
    ...
    const i = parseInt(window.getComputedStyle(s).paddingTop, 10),
      l = window.scrollY + s.getBoundingClientRect().top - rf() + i;
    requestAnimationFrame(r);
  }
}
function _s(e) {
  const t = new URL(e, Ao);
  return (
  ...
  ge &&
    window.addEventListener('click', (e) => {
      ...
      if (t.matches('.vp-code-group input')) {
        ...
        if (!i) return;
        const l = Array.from(i.children).find((u) =>
...
function Wf(e, t) {
  ...
  const r = (i) => {
    ...
    const l = i.map(bs);
    (s.forEach((o, c) => {
      const u = l.findIndex((a) =>
        a == null ? void 0 : a.isEqualNode(o ?? null)
      );
...
function uf(e) {
  return e.filter((t) => !ff(t));
}
const ws = new Set(),
  Mo = () => document.createElement('link'),
  df = (e) => {
    const t = Mo();
