...
var Ot = (a, e, t) =>
  e in a
    ? Ft(a, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
    : (a[e] = t);
var Ae = (a, e, t) => Ot(a, typeof e != 'symbol' ? e + '' : e, t);
import {
  V as Ct,
  D as le,
  h as ge,
...
import { u as ns, c as is } from './theme.B3YsaySe.js';
const rs = {
  root: () => Ct(() => import('./@localSearchIndexroot.CT-9tDgp.js'), []),
};
/*!
 * tabbable 6.3.0
 ...
 */ var mt = [
  ...
  bt = function (e, t, s) {
    ...
    return (t && re.call(e, Ne) && n.unshift(e), (n = n.filter(s)), n);
  },
  Oe = function (e, t, s) {
      ...
      if (!ye(i, !1))
        if (i.tagName === 'SLOT') {
          ...
          var m =
            ...
            f = !ye(m, !1) && (!s.shadowRootFilter || s.shadowRootFilter(i));
          if (m && f) {
            var g = Oe(m === !0 ? i.children : m.children, !0, s);
            s.flatten
              ? n.push.apply(n, g)
              : n.push({ scopeParent: i, candidates: g });
  ...
  ie = function (e) {
    ...
    return e.tabIndex < 0 &&
      (/^(AUDIO|VIDEO|DETAILS)$/.test(e.tagName) || as(e)) &&
      !yt(e)
      ? 0
      : e.tabIndex;
  },
  ...
  ms = function (e, t) {
    ...
    var i = re.call(e, 'details>summary:first-of-type'),
    ...
    if (!s || s === 'full' || s === 'full-native' || s === 'legacy-full') {
      if (typeof n == 'function') {
        for (var l = e; e; ) {
          var c = e.parentElement,
            h = Fe(e);
          if (c && !c.shadowRoot && n(c) === !0) return ot(e);
          e.assignedSlot
            ? (e = e.assignedSlot)
            : !c && h !== e.ownerDocument
              ? (e = h.host)
      ...
      if (vs(e)) return !e.getClientRects().length;
      if (s !== 'legacy-full') return !0;
    } else if (s === 'non-zero-area') return ot(e);
    return !1;
  },
  gs = function (e) {
  ...
  Ce = function (e, t) {
    return !(t.disabled || ye(t) || cs(t) || ms(t, e) || us(t) || gs(t));
  },
  Be = function (e, t) {
    return !(ps(t) || ie(t) < 0 || !Ce(e, t));
  },
  bs = function (e) {
  ...
  xt = function (e) {
    ...
    return (
      ...
      s
        ...
        .reduce(function (n, r) {
          return (
            r.isScope ? n.push.apply(n, r.content) : n.push(r.content),
            n
          );
        }, [])
        .concat(t)
  ...
  ws = function (e, t) {
    ...
    return (
      t.getShadowRoot
        ...
        : (s = bt(e, t.includeContainer, Ce.bind(null, t))),
      s
    );
  },
  ae = function (e, t) {
    if (((t = t || {}), !e)) throw new Error('No node provided');
    return re.call(e, Ne) === !1 ? !1 : Be(t, e);
  },
  xs = mt.concat('iframe').join(','),
  Le = function (e, t) {
    if (((t = t || {}), !e)) throw new Error('No node provided');
    return re.call(e, xs) === !1 ? !1 : Ce(t, e);
  };
/*!
 * focus-trap 7.6.6
    ...
    var s = (t == null ? void 0 : t.document) || document,
      ...
      h = function (u) {
        var d =
          ...
          _ = r[u];
        if (
          (typeof _ == 'function' && (_ = _.apply(void 0, Is(F))),
          _ === !0 && (_ = void 0),
          !_)
        ) {
          ...
          ((i.containerGroups = i.containers.map(function (u) {
            ...
            return {
              ...
              nextTabbableNode: function (p) {
                ...
                return O < 0
                  ? I
                    ? b.slice(b.indexOf(p) + 1).find(function (P) {
                        return ae(P);
                      })
                    : b
                        .slice(0, b.indexOf(p))
      ...
      y = function (u) {
        ...
        if (i.tabbableGroups.length > 0) {
          var _ = c(d, b),
            R = _ >= 0 ? i.containerGroups[_] : void 0;
          if (_ < 0)
            T
              ? (F =
            ...
            } else be(b) || (F = R.nextTabbableNode(d, !1));
          } else {
            ...
            } else be(b) || (F = R.nextTabbableNode(d));
          }
      ...
      A = function (u) {
        var d = Te(u),
          b = c(d, u) >= 0;
        if (b || d instanceof Document) b && (i.mostRecentlyFocusedNode = d);
        else {
          ...
          if (i.mostRecentlyFocusedNode)
            if (ie(i.mostRecentlyFocusedNode) > 0) {
              var F = c(i.mostRecentlyFocusedNode),
                _ = i.containerGroups[F].tabbableNodes;
              if (_.length > 0) {
                var R = _.findIndex(function (v) {
                  return v === i.mostRecentlyFocusedNode;
                });
                R >= 0 &&
                  (r.isKeyForward(i.recentNavEvent)
                    ? R + 1 < _.length && ((E = _[R + 1]), (T = !1))
                    : R - 1 >= 0 && ((E = _[R - 1]), (T = !1)));
              }
            } else
          ...
          (T &&
            ...
            w(E || i.mostRecentlyFocusedNode || m()));
        }
      ...
      J = function (u) {
        ...
        i.recentNavEvent = u;
        var b = y({ event: u, isBackward: d });
        b && (be(u) && u.preventDefault(), w(b));
      },
      Q = function (u) {
      ...
      M = function (u) {
        var d = u.some(function (b) {
          var E = Array.from(b.removedNodes);
      ...
      (o = {
        ...
        activate: function (u) {
          ...
          var d = l(u, 'onActivate'),
            b = l(u, 'onPostActivate'),
            E = l(u, 'checkCanFocusTrap');
          (E || f(),
            (i.active = !0),
            (i.paused = !1),
            (i.nodeFocusedBeforeActivation = g(s)),
            d == null || d());
          var T = function () {
            (E && f(), j(), U(), b == null || b());
          };
        ...
        deactivate: function (u) {
          ...
          (clearTimeout(i.delayInitialFocusTimer),
            ...
            (i.paused = !1),
            U(),
            ut.deactivateTrap(n, o));
          var b = l(d, 'onDeactivate'),
          ...
          var _ = function () {
            dt(function () {
              (F && w(S(i.nodeFocusedBeforeActivation)), E == null || E());
            });
          };
          return F && T
            ? (T(S(i.nodeFocusedBeforeActivation)).then(_, _), this)
            : (_(), this);
        },
        pause: function (u) {
          return i.active
        ...
        updateContainerElements: function (u) {
          ...
          return (
            (i.containers = d.map(function (b) {
              return typeof b == 'string' ? s.querySelector(b) : b;
            })),
            i.active && f(),
            U(),
            this
    ...
    for (; m(); )
      (this.iframes &&
        this.forEachIframe(
          ...
          (f) => {
            this.createInstanceOnIframe(f).forEachNode(e, (g) => l.push(g), n);
          }
        ),
        l.push(c));
    (l.forEach((f) => {
...
class X {
  ...
  set(e, t) {
    ...
    return ((this._size = void 0), Pe(this._tree, e).set(D, t), this);
  }
  get size() {
...
const Re = (a, e, t = []) => {
  ...
  Ke = (a, e) => {
    ...
    for (const t of a.keys())
      if (t !== D && e.startsWith(t)) return Ke(a.get(t), e.slice(t.length));
  },
  Pe = (a, e) => {
    const t = e.length;
    e: for (let s = 0; a && s < t; ) {
  ...
  Tt = (a) => {
    ...
    const [e, t] = Ue(a);
    if ((e.delete(t), e.size === 0)) Tt(a.slice(0, -1));
    else if (e.size === 1) {
...
class ue {
  constructor(e) {
    ...
    const t = e.autoVacuum == null || e.autoVacuum === !0 ? $e : e.autoVacuum;
    ((this._options = {
      ...Ve,
      ...e,
      autoVacuum: t,
      searchOptions: { ...ht, ...(e.searchOptions || {}) },
      ...
      (this._enqueuedVacuumConditions = qe),
  ...
  add(e) {
    ...
    for (const h of i) {
      ...
      const f = n(s(m, h), h),
        g = this._fieldIds[h],
        w = new Set(f).size;
      this.addFieldLength(c, g, this._documentCount - 1, w);
      for (const S of f) {
        const y = r(S, h);
        if (Array.isArray(y)) for (const C of y) this.addTerm(g, c, C);
        else y && this.addTerm(g, c, y);
      }
    }
  }
  addAll(e) {
  ...
  remove(e) {
    ...
    if (c == null)
      throw new Error(
        `MiniSearch: cannot remove document with ID ${l}: it is not in the index`
      );
    for (const h of i) {
      const m = n(e, h);
      if (m == null) continue;
      const f = t(r(m, h), h),
        g = this._fieldIds[h],
        w = new Set(f).size;
      this.removeFieldLength(c, g, this._documentCount, w);
      for (const S of f) {
        const y = s(S, h);
        if (Array.isArray(y)) for (const C of y) this.removeTerm(g, c, C);
        else y && this.removeTerm(g, c, y);
      }
    }
  ...
  async performVacuuming(e, t) {
    ...
    if (this.vacuumConditionsMet(t)) {
      const n = e.batchSize || Je.batchSize,
        r = e.batchWait || Je.batchWait;
      let i = 1;
  ...
  search(e, t = {}) {
    ...
    return ((e === ue.wildcard && n.boostDocument == null) || i.sort(pt), i);
  }
  autoSuggest(e, t = {}) {
  ...
  static getDefault(e) {
    if (Ve.hasOwnProperty(e)) return ze(Ve, e);
  ...
  static async loadJSAsync(e, t) {
    const {
      ...
      l = this.instantiateMiniSearch(e, t);
    ((l._documentIds = await ke(n)),
      (l._fieldLength = await ke(r)),
      (l._storedFields = await ke(i)));
    ...
    for (const [h, m] of s) {
      ...
      for (const g of Object.keys(m)) {
        let w = m[g];
        (o === 1 && (w = w.ds), f.set(parseInt(g, 10), await ke(w)));
      }
      (++c % 1e3 === 0 && (await Nt(0)), l._index.set(h, f));
    }
    return l;
  }
  ...
  executeQuery(e, t = {}) {
    ...
    if (typeof e != 'string') {
      const f = { ...t, ...e, queries: void 0 },
        g = e.queries.map((w) => this.executeQuery(w, f));
  ...
  executeQuerySpec(e, t) {
    const s = { ...this._options.searchOptions, ...t },
      n = (s.fields || this._options.fields).reduce(
        (S, y) => ({ ...S, [y]: ze(s.boost, y) || 1 }),
        {}
      ),
      { boostDocument: r, weights: i, maxFuzzy: o, bm25: l } = s,
      { fuzzy: c, prefix: h } = { ...ht.weights, ...i },
    ...
    if ((e.prefix && (g = this._index.atPrefix(e.term)), e.fuzzy)) {
      const S = e.fuzzy === !0 ? 0.2 : e.fuzzy,
        y = S < 1 ? Math.min(o, Math.round(e.term.length * S)) : S;
      y && (w = this._index.fuzzyGet(e.term, y));
    }
    if (g)
      for (const [S, y] of g) {
        const C = S.length - e.term.length;
        if (!C) continue;
        w == null || w.delete(S);
        const A = (h * S.length) / (S.length + 0.3 * C);
        this.termResults(e.term, S, A, e.termBoost, y, n, r, l, f);
      }
    if (w)
      for (const S of w.keys()) {
        const [y, C] = w.get(S);
        if (!C) continue;
        const A = (c * S.length) / (S.length + C);
        this.termResults(e.term, S, A, e.termBoost, y, n, r, l, f);
      }
    return f;
  }
  ...
  termResults(e, t, s, n, r, i, o, l, c = new Map()) {
    ...
    for (const h of Object.keys(i)) {
      ...
      if (g == null) continue;
      let w = g.size;
      const S = this._avgFieldLength[f];
      for (const y of g.keys()) {
        if (!this._documentIds.has(y)) {
          (this.removeTerm(f, y, t), (w -= 1));
          continue;
        }
        const C = o
        ...
        if (!C) continue;
        const A = g.get(y),
          J = this._fieldLength.get(y)[f],
          Q = Js(A, w, this._documentCount, J, S, l),
          W = s * n * m * C * Q,
          $ = c.get(y);
        if ($) {
          (($.score += W), Gs($.terms, e));
        ...
        } else c.set(y, { score: W, terms: [e], match: { [t]: [h] } });
      }
    }
    return c;
  }
...
const ze = (a, e) =>
  ...
  Us = { combineWith: kt, prefix: (a, e, t) => e === t.length - 1 },
  Je = { batchSize: 1e3, batchWait: 10 },
  qe = { minDirtFactor: 0.1, minDirtCount: 20 },
  $e = { ...Je, ...qe },
  Gs = (a, e) => {
  ...
  ke = async (a) => {
    ...
    for (const s of Object.keys(a))
      (e.set(parseInt(s, 10), a[s]), ++t % 1e3 === 0 && (await Nt(0)));
    return e;
  },
...
const Ys = ['aria-owns'],
    ...
    setup(a, { emit: e }) {
      ...
      const t = e,
        ...
        f = ge(() => {
          ...
          ? he('')
          : Pt('vitepress:local-search-filter', ''),
        g = zt(
          'vitepress:local-search-detailed-list',
          ((_ = c.value.search) == null ? void 0 : _.provider) === 'local' &&
      ...
      const A = st(async () => {
          if (n.value) return at(new zs(n.value));
        }, null),
        J = new Qs(16);
      $t(
        ...
        async ([v, p, I], O, P) => {
          ...
          if (
            ...
            return;
          ((y.value = v.search(p).slice(0, 16)), (C.value = !0));
          const V = I ? await Promise.all(y.value.map((B) => Q(B.id))) : [];
          if (z) return;
          for (const { id: B, mod: te } of V) {
            ...
            if ((G != null && G.render) || (G != null && G.setup)) {
              ...
              (ne.mount(Ye),
                Ye.querySelectorAll('h1, h2, h3, h4, h5, h6').forEach((de) => {
                  var et;
                  const _e =
                      (et = de.querySelector('a')) == null
                        ? void 0
                        : et.getAttribute('href'),
                    Ze =
                      (_e == null ? void 0 : _e.startsWith('#')) && _e.slice(1);
                  if (!Ze) return;
                  let Xe = '';
                  for (
                    ;
          ...
          for (const B of K)
            (xe = B.querySelector('mark[data-markjs="true"]')) == null ||
              xe.scrollIntoView({ block: 'center' });
          (Qe = (He = n.value) == null ? void 0 : He.firstElementChild) ==
            null || Qe.scrollIntoView({ block: 'start' });
        },
        { debounce: 200, immediate: !0 }
      );
      async function Q(v) {
        const p = es(v.slice(0, v.indexOf('#')));
        try {
      ...
      (Se('ArrowUp', (v) => {
        (v.preventDefault(),
          M.value--,
          M.value < 0 && (M.value = y.value.length - 1),
          (q.value = !0),
          U());
      }),
        Se('ArrowDown', (v) => {
          (v.preventDefault(),
            M.value++,
            M.value >= y.value.length && (M.value = 0),
            (q.value = !0),
            U());
        }));
      const N = jt();
      ...
      const b = Wt(Kt ? document.body : null);
      (Me(() => {
        fe(() => {
          ((b.value = !0), fe().then(() => o()));
        });
              ...
              [
                ...
                x('div', Zs, [
                  x(
                    ...
                    {
                      class: 'search-bar',
                      onPointerup: p[4] || (p[4] = (k) => we(k)),
                      onSubmit: p[5] || (p[5] = Ut(() => {}, ['prevent'])),
                    },
                    [
                      x(
                        'label',
                  ...
                  x(
                    'ul',
                    {
                      ...
                      ref: n,
                      id:
                        (P = y.value) != null && P.length
                          ? 'localsearch-list'
                          : void 0,
                      role:
                        (z = y.value) != null && z.length ? 'listbox' : void 0,
                      'aria-labelledby':
                        (V = y.value) != null && V.length
                          ? 'localsearch-label'
                          : void 0,
                      class: 'results',
                      onMousemove: F,
                    ...
                    [
                      ...
                      L(f) && !y.value.length && C.value
                        ? (H(),
                          Z('li', gn, [
                            pe(ve(L(d)('modal.noResultsText')) + ' "', 1),
                            x('strong', null, ve(L(f)), 1),
                            p[15] || (p[15] = pe('" ', -1)),
                          ]))
                        : Ee('', !0),
                    ],
  ...
  Fn = ss(Sn, [['__scopeId', 'data-v-ce626c7c']]);
